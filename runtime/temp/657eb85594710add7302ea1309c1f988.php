<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"E:\laragon\www\h5\public/../application/basketball\view\game_phase\phase_list.html";i:1538034739;s:62:"E:\laragon\www\h5\application\basketball\view\public\meta.html";i:1537249833;s:64:"E:\laragon\www\h5\application\basketball\view\public\footer.html";i:1537249833;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<a href="javascript:;" onclick="add('添加赛事阶段赛','/basketball/game_Phase/phase/bigGame_id/<?php echo $bigGame_id; ?>','500','300')" class="btn btn-primary radius">
    ...
    <table class="table table-border table-bg">
        ...
        <tr class="text-c">
            ...
            <!--<td><?php echo $v['game_win_number']; ?></td>-->
            ...
            <td class="td-manage">
                <a title="编辑" href="javascript:;"
                   onclick="edit('编辑','<?php echo url('gamePhase/phase',['id'=>$v['id']]); ?>','1','500','300')" class="ml-5" style="color: #2a58ee;font-size: 16px">
                    修改
                </a>
                <a href="javascript:;"
                   data-title="查看赛程"
                   data-href="<?php echo url('gameLive/liveList',['phase_id'=>$v['id'],'bigGame_id'=>$v['bigGame_id']]); ?>"
                   onclick="Hui_admin_tab(this)" style="color: #2a58ee;font-size: 16px">
                    查看赛程
                </a>

                <a title="删除" href="javascript:;" onclick="del(this,'<?php echo $v['id']; ?>')" class="ml-5" style="color: #bd130c;font-size: 16px">
                    删除
                </a>
            </td>
        </tr>
    ...
    */
    ...
    function del(obj,id)
    {
        layer.confirm('确认要删除吗？',function(index)
        {
            $.ajax({
                type: 'POST',
                url: "<?php echo url('gamePhase/del'); ?>",
                dataType: 'json',
                data:{'id':id},
