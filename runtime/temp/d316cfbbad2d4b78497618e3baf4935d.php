<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/www/h5/public/../application/football/view/guess/edit_guess.html";i:1540128810;s:50:"/www/h5/application/football/view/public/meta.html";i:1539429417;s:52:"/www/h5/application/football/view/public/footer.html";i:1539429417;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<form method="post" class="form form-horizontal" id="add-game-guess">
        ...
        <tbody>
            <tr class="text-c">
                ...
                <td>
                    <input type="text"
                           onfocus="selecttime()"
                           value="<?php echo date('Y-m-d H:i:s',$start_time); ?>"
                           name="start_time"
            ...
            <tr class="text-c">
                ...
                <td>
                    <input type="text" name="1_winner_id"
                           onblur="winner_odds()" id="1_winner_id"
                           value="<?php echo $guess_winner_one['1_winner_odds']; ?>" placeholder="A胜" autocomplete="off">
                </td>
                <td><strong><span>*</span>胜负赔率</strong></td>
                <td>
                    <input type="text" name="2_winner_id"
                           onblur="winner_odds()" id="2_winner_id"
                           value="<?php echo $guess_winner_one['2_winner_odds']; ?>" placeholder="B胜" autocomplete="off">
                </td>
                <td><strong><span>*</span>平局赔率</strong></td>
                <td>
                    <input type="text" name="3_winner_id"
                           onblur="winner_odds()" id="3_winner_id"
                           value="<?php echo $guess_winner_one['3_winner_odds']; ?>" placeholder="B胜" autocomplete="off">
                </td>
            ...
            <tr class="text-c">
                ...
                <td>
                    <input type="text" name="1_winner_rangfen"
                           value="<?php echo $guess_winner_rangfen_one['1_winner_rangfen']; ?>"
                           placeholder="A让分数值" autocomplete="off">
                </td>
                <td><input type="text" name="1_rangfen_odds"
                           id="1_rangfen_odds" onblur="rf_odds()"
                           value="<?php echo $guess_winner_rangfen_one['1_rangfen_odds']; ?>"
                           placeholder="A让分赔率" autocomplete="off"></td>

                <td>
                    <input type="text" name="2_rangfen_odds"
                           id="2_rangfen_odds" onblur="rf_odds()"
                           value="<?php echo $guess_winner_rangfen_one['2_rangfen_odds']; ?>"
                           placeholder="B让分赔率" autocomplete="off">
                </td>
                <td>
                    <input type="text" name="3_rangfen_odds"
                           id="3_rangfen_odds" onblur="rf_odds()"
                           value="<?php echo $guess_winner_rangfen_one['3_rangfen_odds']; ?>"
                           placeholder="平局赔率" autocomplete="off">
                </td>
                <td>
            ...
            <tr class="text-c">
                ...
                <td>
                    <input type="text" name="1_score_odds"
                           id="1_score_odds" onblur="isscore_odds()"
                           value="<?php echo $guess_is_score_one['1_score_odds']; ?>"
                           placeholder="是">
                </td>
                <td><input type="text" name="2_score_odds"
                           id="2_score_odds" onblur="isscore_odds()"
                           value="<?php echo $guess_is_score_one['2_score_odds']; ?>"
                           placeholder="否">
                </td>
                <td>
            ...
            <tr class="text-c">
                ...
                <td><input type="text" name="total_score"
                           value="2.5" placeholder="请输入两队总进球数"
                           style="background-color:#cccccc"
                           readonly></td>
                <td>
                    <input type="text" name="1_compare_odds"
                           id="1_compare_odds" onblur="totalscore_odds()"
                           value="<?php echo $guess_total_score_one['1_compare_odds']; ?>" placeholder="大于进球数赔率">
                </td>
                <td>
                    <input type="text" name="2_compare_odds"
                           id="2_compare_odds" onblur="totalscore_odds()"
                           value="<?php echo $guess_total_score_one['2_compare_odds']; ?>" placeholder="小于进球数赔率">
                </td>
                <td>
    ...
    <div style="text-align: center">
        ...
        <input hidden value="<?php echo $guess_is_score_one['id']; ?>" name="guess_is_score_id">
        <input hidden value="<?php echo $guess_total_score_one['id']; ?>" name="guess_total_score_id">
    ...
    $(function(){
        ...
        $("#add-game-guess").validate({
            ...
            submitHandler:function(form)
            {
                ...
                url = "<?php echo url('guess/editGuess'); ?>";
