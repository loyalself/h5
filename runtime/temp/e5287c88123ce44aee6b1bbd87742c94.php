<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"E:\laragon\www\h5\public/../application/basketball\view\game_live\live_list.html";i:1538035331;s:62:"E:\laragon\www\h5\application\basketball\view\public\meta.html";i:1537249833;s:64:"E:\laragon\www\h5\application\basketball\view\public\footer.html";i:1537249833;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        ...
        <a class="btn btn-primary radius"
           onclick='add_game("<?php echo url('gameLive/live',['bigGame_id'=>$bigGame_id,'phase_id'=>$phase_id]); ?>")' href="javascript:;">
            <i class="Hui-iconfont">&#xe600;</i> 添加比赛
        </a>
        ...
        <tr class="text-c">
            ...
            <td class="td-manage">
               <!-- <a class="btn btn-primary radius"
                ...
                <a class="btn btn-primary radius"
                   href="javascript:;"
                   onclick='xiugai_game("<?php echo url('gameLive/live',['id'=>$v['id']]); ?>")'>
                    修改
                </a>
