<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"E:\laragon\www\h5\public/../application/ymq\view\banner\banner.html";i:1537964808;s:55:"E:\laragon\www\h5\application\ymq\view\public\meta.html";i:1537249833;s:57:"E:\laragon\www\h5\application\ymq\view\public\footer.html";i:1537249833;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form-admin-add" method="post">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <!--<img style="display: none" id="upload_org_code_imgsv" src="" width="200" height="200">   &lt;!&ndash;上传成功后缩略图展示&ndash;&gt;-->
                <img
                ...
                src="<?php echo !empty($one['banner_url'])?$one['banner_url']:''; ?>"
                width="200" height="200">

                <input id="file_upload_image" name="banner_url" type="hidden" multiple="true" value="">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="redirect_url" name="redirect_url">
            </div>
        </div>
        <div class="row cl">
