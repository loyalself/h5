<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"E:\laragon\www\h5\public/../application/ymq\view\star\index.html";i:1537964208;s:55:"E:\laragon\www\h5\application\ymq\view\public\meta.html";i:1537249833;s:57:"E:\laragon\www\h5\application\ymq\view\public\footer.html";i:1537249833;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<a href="javascript:;" onclick="add('添加球员或国家','/ymq/star/star','700','500')" class="btn btn-primary radius">
    ...
    <table class="table table-border table-bg">
        ...
        <tr class="text-c">
            ...
            <td>
                <?php switch($v['gender']): case "1": ?>男<?php break; case "2": ?>女<?php break; case "3": ?>无<?php break; default: ?>无
                <?php endswitch; ?>
            </td>

            <td>
                <img src="<?php echo $v['pic']; ?>" style="width: 80px;height:80px">
            </td>
            <td class="td-status">
                <?php if($v['status'] == 1): ?>
            ...
            <td class="td-manage">
                <a style="text-decoration:none"
                   onClick="changeStatus('<?php echo $v['id']; ?>',
                    '<?php echo $v['status']==1?2 : 1; ?>',
                    'status',
                    '<?php echo $v['status']==1?'您确认要禁用吗':'您确认要启用么'; ?>')"
                   href="javascript:;" title="停用">
                    <i class="Hui-iconfont">&#xe631;</i>
                </a>

                <a title="编辑" href="javascript:;" onclick="edit('编辑','<?php echo url('star/star',['id'=>$v['id']]); ?>','1','800','600')" class="ml-5" style="text-decoration:none">
                    <i class="Hui-iconfont">&#xe6df;</i>
                </a>
    ...
    */
    ...
    function changeStatus(id,value,field,message)
    {
        layer.confirm(message,function(index)
        {
            ...
            $.ajax({
                type:'post',
                url:"<?php echo url('star/changeStatus'); ?>",
