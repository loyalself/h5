<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"E:\laragon\www\h5\public/../application/ymq\view\collection\collec_list.html";i:1538018856;s:55:"E:\laragon\www\h5\application\ymq\view\public\meta.html";i:1537249833;s:57:"E:\laragon\www\h5\application\ymq\view\public\footer.html";i:1537249833;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <tr class="text-c">
            ...
            <td><?php echo $v['video_source']; ?></td>
            <td>
                <?php if($v['analysis_type'] == 1): ?>
                  <strong>直接播放</strong>
                <?php elseif($v['analysis_type'] == 2): ?>
                 <strong>点亮解析</strong>
                <?php endif; ?>
            </td>
            <td class="td-manage">
                <a title="编辑" href="javascript:;" onclick="admin_edit('编辑','<?php echo url('collection/collection',['id'=>$v['id']]); ?>','1','800','500')" class="ml-5" style="text-decoration:none">
    ...
    */
    ...
    function del(obj,id)
    {
        layer.confirm('确认要删除吗？',function(index)
        {
            $.ajax({
                type: 'POST',
                url: "<?php echo url('collection/del'); ?>",
                dataType: 'json',
                data:{'id':id},
