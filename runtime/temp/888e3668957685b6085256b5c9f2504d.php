<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/www/h5/public/../application/football/view/guess/guess_list.html";i:1540122292;s:50:"/www/h5/application/football/view/public/meta.html";i:1539429417;s:52:"/www/h5/application/football/view/public/footer.html";i:1539429417;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<nav class="breadcrumb">
    <i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>查看竞猜
...
<div class="page-container">
    ...
    <table class="table table-border table-bg">
        ...
        <tr class="text-c">
            ...
            <td><?php echo $v['betting_allcount']; ?></td>
            <td><?php echo $v['win_count']; ?>/<?php echo $v['loss_count']; ?></td>
            <td>查看单选</td>
            <td>
              <!--  <a class="btn btn-primary radius"
                ...
                <a class="btn btn-primary radius"
                   onclick='edit_guess("<?php echo url('guess/editGuess',['id'=>$v['id']]); ?>")' href="javascript:;">
                    编辑竞猜
                </a>


                <!--<?php if($v['status'] == 1 && $v['manual_open'] == 1): ?>-->
                    <!--<a href="javascript:;" class="btn btn-success radius"-->
                       <!--onclick="manual_close('<?php echo $v['id']; ?>')">已开启</a>-->
                <!--<?php else: ?>-->
                    <!--<a href="javascript:;" class="btn btn-default radius"-->
                       <!--onclick="manual_open('<?php echo $v['id']; ?>')">未开启</a>-->
                <!--<?php endif; ?>-->
                <!--<a href="javascript;" style="color: #2a58ee;font-size: 16px">关闭</a>-->
                <a title="删除" href="javascript:;" onclick="del(this,'<?php echo $v['id']; ?>')" class="btn btn-danger radius" style="text-decoration:none">删除</a>
            </td>
        </tr>
    ...
    */
    ...
    function manual_close(id)
    {
        layer.confirm('确认关闭该竞猜吗？',function(index)
        {
            $.ajax({
                type: 'POST',
                url: "<?php echo url('guess/manualCloseGuess'); ?>",
                dataType: 'json',
                data:{'id':id},
    ...
    function manual_open(id)
    {
        layer.confirm('确认开启该竞猜吗？',function(index)
        {
            $.ajax({
                type: 'POST',
                url: "<?php echo url('guess/manualOpenGuess'); ?>",
                dataType: 'json',
                data:{'id':id},
                success: function(result)
                {
