<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:55:"/www/h5/public/../application/ymq/view/admin/admin.html";i:1537405715;s:45:"/www/h5/application/ymq/view/public/meta.html";i:1537249833;s:47:"/www/h5/application/ymq/view/public/footer.html";i:1537249833;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
	...
	<form class="form form-horizontal" id="form-admin-add" method="post">
		...
		<div class="row cl">
			...
			<select class="select" name="adminRole" size="1">
				<?php if(is_array($result) || $result instanceof \think\Collection || $result instanceof \think\Paginator): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
					<option value="<?php echo $v['id']; ?>" <?php echo $v['id']==$one['group_id']?'selected' : ''; ?>><?php echo $v['groupname']; ?></option>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input hidden value="<?php echo $one['id']; ?>" name="uid">
