<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\laragon\www\h5\public/../application/ymq\view\game_live\live_list.html";i:1538208059;s:55:"E:\laragon\www\h5\application\ymq\view\public\meta.html";i:1537249833;s:57:"E:\laragon\www\h5\application\ymq\view\public\footer.html";i:1537249833;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    */
    ...
    function del(obj,id)
    {
        //console.log(obj) <a class="btn btn-danger radius" data-title="删除" href="javascript:;" onclick="del(this,'<?php echo $v['id']; ?>')" class="ml-5" > 删除 </a>
        // obj是当前链接接对象
