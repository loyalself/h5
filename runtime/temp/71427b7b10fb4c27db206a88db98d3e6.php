<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"E:\laragon\www\h5\public/../application/ymq\view\admin\admin_list.html";i:1538048410;s:55:"E:\laragon\www\h5\application\ymq\view\public\meta.html";i:1537249833;s:57:"E:\laragon\www\h5\application\ymq\view\public\footer.html";i:1537249833;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
	<div class="text-c">
		...
		<button type="submit" class="btn btn-success" id="username" name="username"><i class="Hui-iconfont">&#xe665;</i> 搜用户</button>
	</div>
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<!--</a>-->
			<a href="javascript:;" onclick="admin_add('添加管理员','/ymq/admin/admin','800','500')" class="btn btn-primary radius">
			...
			<tr class="text-c">
				...
				<td class="td-manage">
					...
					<a style="text-decoration:none" class="ml-5"
					   onClick="change_password('修改密码','<?php echo url('admin/pwdEdit',['id'=>$v['id']]); ?>','500','300')" href="javascript:;" title="修改密码">
						<i class="Hui-iconfont">&#xe63f;</i>
					</a>
					<a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','<?php echo url('admin/admin',['id'=>$v['id']]); ?>','1','400','250')" class="ml-5" style="text-decoration:none">
						<i class="Hui-iconfont">&#xe6df;</i>
					</a>
