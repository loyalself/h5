<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"/www/h5/public/../application/football/view/game_live/live_list.html";i:1540289211;s:50:"/www/h5/application/football/view/public/meta.html";i:1539429417;s:52:"/www/h5/application/football/view/public/footer.html";i:1539429417;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <table class="table table-border table-bg">
        ...
        <tr class="text-c">
            ...
            <td>
                <?php if($v['is_end'] == 3 && $v['isSettlement'] == 0): ?>
                  <a href="javascript:;"
                     onclick="Settlement('<?php echo $v['id']; ?>')"
                     class="btn btn-warning btn-lg radius"
                     role="button">结算
                  </a>
                <?php elseif($v['isSettlement'] == 1): ?>
                  <a href="#" class="btn btn-default btn-lg disabled radius" role="button">
                      已结算
                  </a>
                <?php elseif($v['is_end'] == 4): ?>
                <a href="#" class="btn btn-default btn-lg disabled radius" role="button">
                    已结算
                </a>
                <?php elseif($v['is_end'] != 3): ?>
                <a href="#" class="btn btn-default btn-lg disabled radius" role="button">
                    结算
                </a>
                <?php endif; ?>
...
<script type="text/javascript">
    ...
    */
    ...
    function Settlement(id)
    {
        $.ajax({
            type: 'GET',
            url: "<?php echo url('gameLive/settlement'); ?>",
            dataType: 'json',
            data:{'id':id},
