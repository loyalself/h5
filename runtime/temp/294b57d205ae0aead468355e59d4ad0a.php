<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"E:\laragon\www\h5\public/../application/ymq\view\admin_role_group\role_list.html";i:1537249833;s:55:"E:\laragon\www\h5\application\ymq\view\public\meta.html";i:1537249833;s:57:"E:\laragon\www\h5\application\ymq\view\public\footer.html";i:1537249833;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray">
        <span class="l">
			...
			<!--</a>-->
		    <a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('添加角色权限','/ymq/admin_role_group/role','800','500')">
			    <i class="Hui-iconfont">&#xe600;</i> 添加角色权限</a>
        </span>
	...
	<table class="table table-border table-bordered table-hover table-bg">
		<thead>
			...
			<tr class="text-c">
				...
				<th width="40">ID</th>
				<th width="100">角色分组名称</th>
				<th width="300">权限描述</th>
				<th width="60">状态</th>
				<th width="70">操作</th>
			</tr>
		</thead>
			...
			<tr class="text-c">
				...
				<td class="f-14">
					<a title="编辑" href="javascript:;"
					   onclick="admin_role_edit('角色编辑','<?php echo url('adminRoleGroup/role',['id'=>$v['id']]); ?>','1','800','500')"
