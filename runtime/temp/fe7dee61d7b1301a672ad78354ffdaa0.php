<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"E:\laragon\www\h5\public/../application/ymq\view\match\matchlist.html";i:1538034107;s:55:"E:\laragon\www\h5\application\ymq\view\public\meta.html";i:1537249833;s:57:"E:\laragon\www\h5\application\ymq\view\public\footer.html";i:1537249833;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
       ...
       <!-- <a class="btn btn-primary radius"
           data-title="添加大赛"
           data-href="<?php echo url('match/addmatch'); ?>"
           onclick="Hui_admin_tab(this)" href="javascript:;">
            <i class="Hui-iconfont">&#xe600;</i> 添加大赛
        </a>-->

        <a class="btn btn-primary radius" onclick="add('addmatch.html')" href="javascript:;">
            <i class="Hui-iconfont">&#xe600;</i> 添加大赛
        </a>
    </div>
    <div class="mt-20">
               ...
               <!-- <td><input type="checkbox" value="" name=""></td>-->
                ...
                <td class="f-14 td-manage">
                  ...
                  <!--  <a href="javascript:;"
                       ...
                       data-href="<?php echo url('match/addMatch',['id'=>$v['id']]); ?>"
                       data-title="修改大赛">修改</a>-->

                    <a href="javascript:;"
                       style="color: #2a58ee;font-size: 16px"
                       onclick='xiugai("<?php echo url('match/addMatch',['id'=>$v['id']]); ?>")'
                       >修改</a>
